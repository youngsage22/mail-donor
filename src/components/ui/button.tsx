...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    ...
    const variants = {
      ...
      neon: "bg-primary/10 border-2 border-primary/50 text-primary hover:bg-primary/20 hover:border-primary shadow-[0_0_15px_-3px_var(--color-primary)] hover:shadow-[0_0_25px_-3px_var(--color-primary)] transition-all font-semibold",
    }
    const sizes = {
